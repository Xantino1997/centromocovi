...
import "./styles/PostDetalles.css";
...
export default function PostDetail({}) {
  ...
  return (
    <div className="post-page">
      ...
      <time className="time-post-page">
        {isValid(new Date(postInfo.createdAt))
      ...
      {userInfo.id === (postInfo.author && postInfo.author._id) && (
      ...
      <div className="image">
        <img
          className="post-final"
          src={`https://backend-blog-psi.vercel.app/${postInfo.cover}`}
          alt=""
        />
      </div>
      <div
      ...
      />
      <hr></hr>
      <div className="comparte-titulo">
        <h1 className="comparte-titulo-h1">
          Te gusto el articulo, comparte para seguir ayudando
        </h1>
      </div>
      <div className="events-comparte-redes-post">
        <button
          className="events-comparte-redes-btn"
